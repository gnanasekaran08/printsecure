<script lang="ts">
    ...
    // State
    let currentStep = $state<'upload' | 'settings' | 'checkout' | 'success'>(
        'upload',
    );
    ...
    const estimatedPages = $derived(
        files.reduce((acc, file) => {
            ...
            if (ext === 'pdf')
                return acc + Math.max(1, Math.ceil(file.size / 1024 / 100));
...
>
    <!-- Header -->
    <header
        class="sticky top-0 z-50 border-b border-slate-200/50 bg-white/80 px-4 py-3 backdrop-blur-xl"
    >
    ...
    <main class="mx-auto max-w-lg px-4 py-6">
            ...
            <div class="space-y-6">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-slate-600">
                        Select files you want to print
                    </p>
                </div>
                ...
                >
                    ...
                    />
                    <div
                        class="flex h-12 w-12 items-center justify-center rounded-xl bg-violet-100"
                    >
        ...
        {#if currentStep === 'settings'}
            <div class="space-y-6">
                ...
                <!-- Summary Preview -->
                <div
                    class="rounded-2xl bg-gradient-to-br from-slate-100 to-slate-50 p-4"
                >
        ...
        {#if currentStep === 'checkout' && printJob}
            <div class="space-y-6">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-slate-600">
                        Review and pay for your print job
                    </p>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    >
                        {#if isProcessingPayment}
                            <Loader2 class="h-5 w-5 animate-spin" />
                        {:else}
                            <IndianRupee class="h-5 w-5 text-slate-600" />
                            Pay with Cash
                        {/if}
                    </button>
        ...
        {#if 'success' === currentStep}
            <div class="space-y-8 py-8 text-center">
                ...
                <div class="space-y-3">
                    <a
                        href="/"
                        class="btn btn-lg w-full bg-gradient-to-r from-violet-500 to-indigo-600 text-white shadow-lg"
                    >
                        Back to Home
                    </a>
                    <button
        ...
        <div class="fixed inset-0 z-50">
            ...
            >
                ...
                <div class="space-y-3">
                    ...
                    >
                        <div
                            class="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-orange-400 to-pink-500"
                        >
